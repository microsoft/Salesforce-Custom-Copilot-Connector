...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  python run.py ingest-item --id <salesforce_id>
      ...
      Example: python run.py ingest-item --id 500f6000008iCNYAA2

  python run.py ingest-object --type <object_type>
      Ingests all records of one Salesforce object type.
      Example: python run.py ingest-object --type Case
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Continuous operation:
    5.  python run.py full-deployment --continuous
        ...
        # Incremental only fetches Salesforce records modified since last crawl.

  Preview group-based ACL (without Graph calls):
    6.  python run.py --verbose identity-dry-run
    7.  python run.py --verbose identity-dry-run --save   # also writes to SQLite
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Log files:
    ...
    Example: logs/deployment_20260423_143022.log
  ...
  SQLite state database:
    ...
    │ Table           │ Purpose                                              │
    ├─────────────────┼──────────────────────────────────────────────────────┤
    │ groups          │ External groups published to Graph (group_id,        │
    │                 │ connection_id, display_name, timestamps).            │
    ├─────────────────┼──────────────────────────────────────────────────────┤
    │ group_members   │ Members of each group (group_id, member_id,         │
    │                 │ member_type: "user" or "externalGroup").             │
    │                 │ Used to diff and only push changes to Graph.         │
    ├─────────────────┼──────────────────────────────────────────────────────┤
    │ sync_sessions   │ Audit log of every crawl run.                       │
    │                 │ crawl_type: "identity", "content", "identity-dry-run"│
    │                 │ sync_type:  "full" or "incremental"                 │
    │                 │ Tracks: groups created/updated/deleted, members      │
    │                 │ added/removed, API calls made, content stats.        │
    │                 │ The last content crawl timestamp is used to          │
    │                 │ determine the 'since' parameter for incremental      │
    │                 │ content crawls.                                      │
    └─────────────────┴──────────────────────────────────────────────────────┘
